...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/r-spatialecology/onpoint?branch=master&svg=true)](https://ci.appveyor.com/project/r-spatialecology/onpoint)
